    ...
    return (
        <div className="flex h-screen">
            <div className="bg-white w-1/3 pl-4 pt-4">
                <div className="flex text-blue-600 font-bold gap-2 mb-4">
                ...
                {Object.keys(onlinePeople).map(userId => (
                    <div key={onlinePeople[userId]} className="flex items-center gap-2 border-b border-gray-100 py-2 cursor-pointer">
